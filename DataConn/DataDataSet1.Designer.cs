...
namespace DataConn.DataDataSet1TableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`Name`) VALUES (?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `Name` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) " +
                "OR (`Name` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataConn.Properties.Settings.Default.DataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name FROM Table1";
        ...
        public virtual int Fill(DataDataSet1.Table1DataTable dataTable) {
        ...
        public virtual DataDataSet1.Table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataDataSet1.Table1DataTable dataTable = new DataDataSet1.Table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataDataSet1.Table1DataTable dataTable) {
